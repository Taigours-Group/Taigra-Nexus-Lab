...
export const Services = () => {
  ...
  return (
    <div className="bg-[#050505] min-h-screen text-white">
      <section className="py-24 border-b mb-8 border-white/5 relative overflow-hidden bg-[url('https://res.cloudinary.com/dbjjzyrr3/image/upload/v1772699969/Taigra_Nexus_Labs_Banner_empty.png')] bg-cover bg-center">
